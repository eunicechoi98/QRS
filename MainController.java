...
public class MainController {
    ...
    public void exitAction(ActionEvent event) {
    	...
    	alert.setContentText("You are terminating your session early and it will not be recorded. Please come back to complete the session at your earliest convenience.");
